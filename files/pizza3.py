...
parser.add_argument("-c","--cheese",type=str,default="standard",help="The amount of cheese.  Pick from none, standard, extra, double",choices=['none','standard','extra','double'])
...
if args.pepperoni == True:
  print("You have ordered a " + size + " pepperoni pizzai with " + args.cheese + " cheese.")
else:
  print("You have ordered a " + size + " pizza with " + args.cheese  + " cheese.")
